...
const KNOWN_API_MESSAGES: Record<string, string> = {
  ...
  "Current password is required to set a new password": "Informe a senha atual para definir uma nova senha.",
  ...
  "A pending invitation already exists for that email": "Já existe um convite pendente para esse e-mail.",
  ...
  "You are not the intended recipient of this invitation": "Esse convite foi enviado para outra pessoa.",
  ...
  "Ledger name must have at most 120 characters": "O nome da fatura pode ter no máximo 120 caracteres.",
  ...
  "AI rate limit exceeded for this user": "Limite de perguntas por minuto atingido. Aguarde um instante.",
  "AI rate limit exceeded for this IP": "Limite de perguntas por minuto atingido. Aguarde um instante.",
  "Daily AI quota exceeded for this user": "Cota diária do assistente atingida. Tente novamente amanhã.",
};
