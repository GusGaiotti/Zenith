  ...
  return (
    <div ref={wrapperRef} className="relative space-y-2">
      ...
      {open ? (
        <div
          className={cn(
            "absolute top-[calc(100%+0.5rem)] z-40 w-[280px] rounded-2xl border border-[var(--surface-edge)] bg-[rgba(24,22,19,0.98)] p-3 shadow-[0_20px_60px_rgba(0,0,0,0.42)] backdrop-blur",
